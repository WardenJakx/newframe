...
class AddHardware extends React.Component<any, any> {
  declare store: Store
  deviceName: any
  ...
  override render() {
    ...
    const isType = (id: any) => this.store('main.signers', id, 'type') === this.props.type
    const toDevice = (id: any) => this.store('main.signers', id)
      ...
      <div className='addAccountItem addAccountItemAdding'>
        ...
        <div className='addAccountItemWrap'>
                      ...
                      <>
                        ...
                        {this.state.error ? (
                          <div
                            ...
                            onMouseDown={() => (this as any).restart()}
                          >
                            try again
                          </div>
                        ) : null}
          ...
          <div
            ...
            onClick={() => {
              const open = (url: any) => link.send('tray:openExternal', url)
