...
class AddAccounts extends React.Component<any, any> {
  declare store: Store
  ...
  renderAddKeyring({ accountData }: any) {
    return (
      <div className='addAccounts cardShow'>
  ...
  renderAddKeystore({ accountData }: any) {
    return (
      <div className='addAccounts cardShow'>
