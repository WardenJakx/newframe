...
const isValidRpc = (urlStr: any) => {
  const url = getUrl(urlStr)
  return ['http:', 'https:', 'ws:', 'wss:'].includes(url?.protocol as any)
}

const isValidIcon = (urlStr: any) => Boolean(getUrl(urlStr))
