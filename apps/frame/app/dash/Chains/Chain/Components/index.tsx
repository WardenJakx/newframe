...
export const SubmitChainButton = ({ text, enabled, textColor, onClick }: any) => {
  return (
    <div
      role='button'
      ...
      <div className='signerMenuItems'>
        ...
        {showToggle && (
          <div
            ...
            onClick={
              (!isMainnet ? () => link.send('tray:action', 'activateNetwork', type, id, !on) : null) as any
            }
          >
            {isMainnet ? (
...
export const EditChainColor = ({ currentColor, onChange }: any) => {
  return (
...
export const EditChainField = ({ currentValue, defaultValue, label, onChange }: any) => {
...
export const EditChainName = ({ currentName, onChange }: any) => (
  <EditChainField
...
export const EditChainSymbol = ({ currentSymbol, onChange }: any) => (
  <EditChainField
...
export const EditChainId = ({ chainId, onChange }: any) => (
  <EditChainField
...
export const EditChainExplorer = ({ currentExplorer, onChange }: any) => (
  <EditChainField
...
export const EditChainIcon = ({ currentIcon, onChange }: any) => (
  <EditChainField
...
export const EditNativeCurrencyIcon = ({ currentCurrencyIcon, onChange }: any) => (
  <EditChainField
...
export const EditNativeCurrencyName = ({ currentNativeCurrency, onChange }: any) => (
  <EditChainField
...
export const EditPrimaryRPC = ({ currentPrimaryRPC, onChange }: any) => (
  <EditChainField
...
export const EditSecondaryRPC = ({ currentSecondaryRpc, onChange }: any) => (
  <EditChainField
...
export const EditTestnet = ({ testnet, onChange }: any) => {
  return (
