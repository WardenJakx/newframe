...
class Settings extends React.Component<any, any> {
  ...
  newNetworkIdDefault: string
  newNetworkNameDefault: string
  newNetworkExplorerDefault: string
  newNetworkSymbolDefault: string
