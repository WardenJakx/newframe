...
class Settings extends React.Component<any, any> {
  ...
  customPrimaryInputTimeout: any
  customSecondaryInputTimeout: any
  ...
  expandNetwork(e: any, expand: any) {
    e.stopPropagation()
