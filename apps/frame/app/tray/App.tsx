...
class Panel extends React.Component<any, any> {
  ...
  hexToDisplayGwei(weiHex: any) {
    // NOTE: preserved JS quirk — 'hex' is not a valid radix and coerces to NaN at runtime
    return parseInt(weiHex, 'hex' as any) / 1e9 < 1 ? '‹1' : Math.round(parseInt(weiHex, 'hex' as any) / 1e9)
  }
