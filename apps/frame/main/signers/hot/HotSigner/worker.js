...
const { signTypedData, personalSign, recoverPersonalSignature } = require('@metamask/eth-sig-util')
const { createTx } = require('@ethereumjs/tx')
const { bytesToHex } = require('@ethereumjs/util')
const { Common, createCustomCommon, Holesky, Mainnet, Sepolia } = require('@ethereumjs/common')
...
const knownChains = { 1: Mainnet, 17000: Holesky, 11155111: Sepolia }
