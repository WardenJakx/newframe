...
describe('entering seed phrase', () => {
  const setupComponent = () => {
    ...
    return {
      ...
      enterSeedPhrase: async (text: any) => await user.type(screen.getAllByRole('textbox')[0], text)
    }
  }
...
describe('confirming password', () => {
  const setupComponent = () => {
    ...
    return {
      enterPassword: async (text: any) => user.type(screen.getAllByRole('textbox')[2], text),
