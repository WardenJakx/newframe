...
describe('rendering', () => {
  it('renders the first provided RPC as the primary RPC', () => {
    ...
    const primaryRpcInput = screen.getByLabelText<HTMLInputElement>('Primary RPC')
  ...
  it('renders the second provided RPC as the secondary RPC', () => {
    ...
    const secondaryRpcInput = screen.getByLabelText<HTMLInputElement>('Secondary RPC')
  ...
  it('renders the default chain name', () => {
    ...
    const chainName = screen.getByLabelText<HTMLInputElement>('Chain Name')
  ...
  it('renders the correct chain id', () => {
    ...
    const chainIdInput = screen.getByLabelText<HTMLInputElement>('Chain ID')
  ...
  it('renders the correct native symbol', () => {
    ...
    const chainIdInput = screen.getByLabelText<HTMLInputElement>('Native Symbol')
