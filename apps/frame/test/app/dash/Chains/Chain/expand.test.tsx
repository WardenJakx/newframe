...
describe('rendering', () => {
  it('renders the provided chain name', () => {
    ...
    const chainNameInput = screen.getByLabelText<HTMLInputElement>('Chain Name')
  ...
  it('renders the provided chain symbol', () => {
    ...
    const chainNameInput = screen.getByLabelText<HTMLInputElement>('Native Symbol')
  ...
  it('renders the provided block explorer', () => {
    ...
    const blockExplorerInput = screen.getByLabelText<HTMLInputElement>('Block Explorer')
