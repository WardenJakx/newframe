...
import * as originsModule from '../../../main/api/origins'

// real functions under test, exercised with partial payload fixtures
const { parseOrigin, updateOrigin, isTrusted, parseFrameExtension, isKnownExtension } =
  originsModule as Record<string, any>
