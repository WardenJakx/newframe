...
class MockConnection extends EventEmitter {
  constructor(chainId: any) {
    ...
    ;(this as any).sendAsync = (payload: any, cb: any) => {
...
let block: any, gasPrice: any, observer: any, connectionObserver: any
...
jest.mock('eth-provider', () => (target: any) => (mockConnections as any)[target].connection)
