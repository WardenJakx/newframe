...
import providerModule from '../../../main/provider'
import accountsModule from '../../../main/accounts'
import connectionModule from '../../../main/chains'
import storeModule from '../../../main/store'

// mocked modules are reassigned with partial test doubles, so treat them as any
const provider = providerModule as any
const accounts = accountsModule as any
const connection = connectionModule as any
