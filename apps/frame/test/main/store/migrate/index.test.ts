...
describe('migration 31', () => {
  ...
  it('remove any balances which have the address `0xdeaddeaddeaddeaddeaddeaddeaddeaddead0000`', () => {
    ...
    expect(
      balances[address].find(
        (balance: any) => balance.address === '0xdeaddeaddeaddeaddeaddeaddeaddeaddead0000'
      )
    ).toBeFalsy()
  })
...
describe('migration 32', () => {
  const getKnownTokens = (state: any) => state.main.tokens.known[account]
  ...
  it('should remove any known tokens with the address `0xdeaddeaddeaddeaddeaddeaddeaddeaddead0000`', () => {
    ...
    expect(
      known.find(({ address }: any) => address === '0xdeaddeaddeaddeaddeaddeaddeaddeaddead0000')
    ).toBeFalsy()
  })
...
describe('migration 34', () => {
  const getNativeCurrency = (state: any, chainId: any) =>
...
describe('migration 37', () => {
  ...
  describe('when altGr is a modifier', () => {
    ...
    it('should update the summon shortcut on Linux', () => {
      ;(isWindows as any).mockReturnValue(false)
    ...
    it('should update the summon shortcut on Windows', () => {
      ;(isWindows as any).mockReturnValue(true)
