...
describe('wei', () => {
  it('should return a wei value', () => {
    ...
    expect(displayValue.wei()).toStrictEqual({ displayValue: '356', value: 356n })
  })

  it('should return a zero wei value', () => {
    const displayValue = displayValueData(0)
    expect(displayValue.wei()).toStrictEqual({ displayValue: '0', value: 0n })
  })
})
...
describe('gwei', () => {
  it('should return a gwei value', () => {
    ...
    expect(displayValue.gwei()).toStrictEqual({ displayValue: '356', value: 356 })
  })

  it('should not return a gwei value of more than 6dp', () => {
    const displayValue = displayValueData(356e-18)
    expect(displayValue.gwei()).toStrictEqual({ displayValue: '0', value: 0 })
  })
...
describe('fiat currency', () => {
  ...
  it('should return "testnet zero" when isTestnet is true', () => {
    const value = displayValueData(356e24, { currencyRate: { price: 1.3 }, isTestnet: true } as any)
    expect(value.fiat()).toStrictEqual({
      displayValue: '?',
      value: 0
    })
  ...
  describe('when displaying decimals', () => {
    it('should return a value of less than a cent', () => {
      const value = displayValueData(356e12, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        approximationSymbol: '<',
        displayValue: '0.01',
        value: 0.000356
    ...
    it('should return a value less than 1000 with a fixed 2dp', () => {
      const value = displayValueData(999999e15, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayValue: '999.99',
        value: 999.999
      })
    ...
    it('should return a zero value', () => {
      const value = displayValueData(0, { currencyRate: { price: 1.3 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayValue: '0.00',
        value: 0
      })
  ...
  describe('when not displaying decimals', () => {
    it('should return a value of less than a dollar', () => {
      const value = displayValueData(356e12, { currencyRate: { price: 1 } } as any)
      expect((value.fiat as any)({ displayDecimals: false })).toStrictEqual({
        approximationSymbol: '<',
        displayValue: '1',
        value: 0.000356
      })
  ...
  describe('shorthand large values', () => {
    it('should return a value of millions to 2dp', () => {
      const value = displayValueData(356253e20, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
          fullName: 'million',
          shortName: 'M'
    ...
    it('should round down a value of millions to 2dp', () => {
      const value = displayValueData(356259e20, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
          fullName: 'million',
          shortName: 'M'
    ...
    it('should return an exact value of millions', () => {
      const value = displayValueData(35e24, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
          fullName: 'million',
          shortName: 'M'
    ...
    it('should return a value of billions to 2dp', () => {
      const value = displayValueData(35.6253e27, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
          fullName: 'billion',
          shortName: 'B'
    ...
    it('should round down a value of billions to 2dp', () => {
      const value = displayValueData(35.6259e27, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
          fullName: 'billion',
          shortName: 'B'
    ...
    it('should return an exact value of billions', () => {
      const value = displayValueData(35e27, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
          fullName: 'billion',
          shortName: 'B'
    ...
    it('should return a value of trillions to 2dp', () => {
      const value = displayValueData(35.6253e30, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
          fullName: 'trillion',
          shortName: 'T'
        ...
        displayValue: '35.62',
        value: 35625300000000
      })
    })

    it('should round down a value of trillions to 2dp', () => {
      const value = displayValueData(35.6259e30, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
          fullName: 'trillion',
          shortName: 'T'
        ...
        displayValue: '35.62',
        value: 35625900000000
      })
    })

    it('should return an exact value of trillions', () => {
      const value = displayValueData(35e30, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
          fullName: 'trillion',
          shortName: 'T'
    ...
    it('should return a value of quadrillions to 2dp', () => {
      const value = displayValueData(35.6253e33, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
    ...
    it('should round down a value of quadrillions to 2dp', () => {
      const value = displayValueData(35.6259e33, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
          fullName: 'quadrillion',
          shortName: 'Q'
    ...
    it('should return an exact value of quadrillions', () => {
      const value = displayValueData(35e33, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        displayUnit: {
          fullName: 'quadrillion',
          shortName: 'Q'
    ...
    it('should return a maximum value', () => {
      const value = displayValueData(356e50, { currencyRate: { price: 1 } } as any)
      expect(value.fiat()).toStrictEqual({
        approximationSymbol: '>',
        displayUnit: {
          fullName: 'quadrillion',
...
describe('ether currency', () => {
  ...
  describe('when not displaying decimals', () => {
    it('should return a value of less than 1', () => {
      ...
      expect((value.ether as any)({ displayDecimals: false })).toStrictEqual({
        approximationSymbol: '<',
        displayValue: '1',
        value: 0.000356
      })
