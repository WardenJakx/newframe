...
import type { AccountRequest, RequestAuthorization, RequestType } from '../contracts/requests.js'
import type { AuthorizationContext, RendererEntrypoint, RendererRole } from './ipc/authorization.js'
