// path data inlined from octicons v8 (previously rendered via @githubprimer/octicons-react)
const octicons: Record<string, { width: number; height: number; path: string }> = {
  check: {
    width: 12,
    height: 16,
    path: 'M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z'
  },
  'kebab-horizontal': {
    width: 13,
    height: 16,
    path: 'M1.5 9a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm5 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM13 7.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z'
  },
  'primitive-dot': {
    width: 8,
    height: 16,
  ...
  'chevron-down': {
    width: 10,
    height: 16,
    path: 'M5 11L0 6l1.5-1.5L5 8.25 8.5 4.5 10 6l-5 5z'
  },
  'chevron-up': {
    width: 10,
    height: 16,
    path: 'M10 10l-1.5 1.5L5 7.75 1.5 11.5 0 10l5-5 5 5z'
  },
  'chevron-left': {
    width: 8,
    height: 16,
    path: 'M5.5 3L7 4.5 3.25 8 7 11.5 5.5 13l-5-5 5-5z'
  },
  sync: {
    width: 12,
    height: 16,
  ...
  shield: {
    width: 14,
    height: 16,
    path: 'M7 0L0 2v6.02C0 12.69 5.31 16 7 16c1.69 0 7-3.31 7-7.98V2L7 0zM5 11l1.14-2.8a.568.568 0 0 0-.25-.59C5.33 7.25 5 6.66 5 6c0-1.09.89-2 1.98-2C8.06 4 9 4.91 9 6c0 .66-.33 1.25-.89 1.61-.19.13-.3.36-.25.59L9 11H5z'
  },
  settings: {
    width: 16,
    height: 16,
    path: 'M4 7H3V2h1v5zm-1 7h1v-3H3v3zm5 0h1V8H8v6zm5 0h1v-2h-1v2zm1-12h-1v6h1V2zM9 2H8v2h1V2zM5 8H2c-.55 0-1 .45-1 1s.45 1 1 1h3c.55 0 1-.45 1-1s-.45-1-1-1zm5-3H7c-.55 0-1 .45-1 1s.45 1 1 1h3c.55 0 1-.45 1-1s-.45-1-1-1zm5 4h-3c-.55 0-1 .45-1 1s.45 1 1 1h3c.55 0 1-.45 1-1s-.45-1-1-1z'
  },
  pulse: {
    width: 14,
    height: 16,
    path: 'M11.5 8L8.8 5.4 6.6 8.5 5.5 1.6 2.38 8H0v2h3.6l.9-1.8.9 5.4L9 8.5l1.6 1.5H14V8h-2.5z'
  }
}
...
export default {
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 576 512' width={size + 'px'} height={size + 'px'}>
          <path
            fill='currentColor'
            d='M288 80C154.8 80 42.3 160.8 0 272c42.3 111.2 154.8 192 288 192s245.7-80.8 288-192C533.7 160.8 421.2 80 288 80zm0 320c-70.7 0-128-57.3-128-128s57.3-128 128-128 128 57.3 128 128-57.3 128-128 128zm0-208c-44.2 0-80 35.8-80 80s35.8 80 80 80 80-35.8 80-80-35.8-80-80-80z'
          />
        </svg>
      </div>
    )
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 512 512' width={size + 'px'} height={size + 'px'}>
          <path
            fill='currentColor'
            d='M410.3 32.5c25-25 65.5-25 90.5 0s25 65.5 0 90.5L185.7 438.1c-4.5 4.5-10.1 7.8-16.2 9.5L39.7 485.3c-8.2 2.4-17.1.1-23.2-6s-8.4-15-6-23.2l37.7-129.8c1.8-6.1 5.1-11.7 9.5-16.2L410.3 32.5zM364.4 91.1l56.6 56.6 34.5-34.5c6.2-6.2 6.2-16.4 0-22.6L421 56.1c-6.2-6.2-16.4-6.2-22.6 0l-34 35z'
          />
        </svg>
      </div>
    )
    ...
    return (
      <div style={{ width: size + 'px', height: size + 'px' }}>
        <svg viewBox='0 0 448 512' width={size + 'px'} height={size + 'px'}>
          <path
            fill='currentColor'
            d='M0 80c0-26.5 21.5-48 48-48h96c26.5 0 48 21.5 48 48v96c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48V80zm64 16v64h64V96H64zM256 80c0-26.5 21.5-48 48-48h96c26.5 0 48 21.5 48 48v96c0 26.5-21.5 48-48 48h-96c-26.5 0-48-21.5-48-48V80zm64 16v64h64V96h-64zM0 336c0-26.5 21.5-48 48-48h96c26.5 0 48 21.5 48 48v96c0 26.5-21.5 48-48 48H48c-26.5 0-48-21.5-48-48v-96zm64 16v64h64v-64H64zM256 288h64v64h-64v-64zm96 0h32v32h-32v-32zm64 0h32v64h-64v-32h32v-32zm-64 96h96v96h-64v-32h-32v32h-64v-64h64v-32zm-96 0h64v64h-64v-64z'
          />
        </svg>
      </div>
    )
  ...
  octicon: (name: string, settings: { height?: number }) => {
    const icon = octicons[name]
    if (!icon) return null
    const height = settings.height || icon.height
