...
mock.module('../../../../../platform/chain-rpc/multicall', () => ({
...
let balanceLoader: any
let multicall: any
let supportsChain: any
const knownTokens = [aaveUsdcToken, zrxToken, badgerDaoToken]

beforeAll(async () => {
  log.transports.console.level = false

  balanceLoader = (await import('./scan')).default
  const multicallModule = await import('../../../../../platform/chain-rpc/multicall')
  multicall = multicallModule.default
  supportsChain = multicallModule.supportsChain
})
