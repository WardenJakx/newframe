...
export interface OperationServices {
  ...
  platform: import('../../../app/main/platform/service.js').PlatformService
  ...
  createRendererPrincipal: typeof import('../../../features/access-control/main/authority.js').createRendererPrincipal
