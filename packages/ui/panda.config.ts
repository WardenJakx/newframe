...
import { colorPrimitives, darkColorSemantics, type SemanticColorName } from './src/tokens/colors.js'
  ...
  theme: {
    extend: {
      tokens: {
        ...
        easings: {
          standard: { value: motionTokens['nf-easing-standard'] }
        },
        fonts: {
        ...
        letterSpacings: {
          title: { value: typographyTokens['nf-letter-spacing-title'] }
        },
        lineHeights: {
          amount: { value: typographyTokens['nf-line-height-amount'] }
        },
